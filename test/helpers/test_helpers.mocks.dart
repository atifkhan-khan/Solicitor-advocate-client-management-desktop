...
// in flutter_desktop_app_advocate/test/helpers/test_helpers.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveDBService extends _i1.Mock implements _i6.HiveDBService {
  @override
  _i4.Future<dynamic> openDB() => (super.noSuchMethod(
        Invocation.method(
          #openDB,
          [],
        ),
  ...
  @override
  _i4.Future<List<_i7.LedgersData>> getLedgers() => (super.noSuchMethod(
        Invocation.method(
          #getLedgers,
          [],
        ),
